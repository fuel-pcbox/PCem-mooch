...
PCem is licensed under the GPLv2+, see COPYING for more details.

Changes since PCem-mooch v11:

- All the various new features of PCem v11, some of which were already in PCem-mooch v11.
- Various fixes
- Rebased onto mainline PCem code, which means networking is no more, unfortunately.
