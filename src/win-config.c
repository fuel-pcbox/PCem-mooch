...
//        pclog("Dialog msg %i %08X\n",message,message);
        switch (message)
        {
                ...
                h = GetDlgItem(hdlg, IDC_COMBOCDCHAN);
                SendMessage(h, CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Pri. Master");
                SendMessage(h, CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Pri. Slave");
                SendMessage(h, CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Sec. Master");
                SendMessage(h, CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Sec. Slave");
                SendMessage(h, CB_SETCURSEL, cdrom_channel, 0);
			...
			update_sync();
                        ...
                        h = GetDlgItem(hdlg, IDC_COMBOCDCHAN);
                        temp_cdrom_channel = SendMessage(h, CB_GETCURSEL, 0, 0);
			    ...
			    temp_fda_type != fdd_get_type(0) || temp_fdb_type != fdd_get_type(1) || temp_cdrom_channel != cdrom_channel || temp_network_card_current != network_card_current)
                        {
					...
					cdrom_channel = temp_cdrom_channel;
