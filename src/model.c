...
/*        {"AMI WinBIOS 486 PCI", ROM_PCI486,    { "Intel", cpus_i486,    "AMD", cpus_Am486, "Cyrix", cpus_Cx486},   0, 1,  1, 256, 1, at_um8881f_init},*/
        ...
        {"Acer M3a",            ROM_ACERM3A,     { "Intel", cpus_Pentium, "IDT", cpus_WinChip, "",      NULL},         0, 1,   1, 512, 1,     at_acerm3a_init},
        {"Acer V35N",           ROM_ACERV35N,    { "Intel", cpus_Pentium, "IDT", cpus_WinChip, "",      NULL},         0, 1,   1, 512, 1,    at_acerv35n_init},
        {"ASUS P/I-P55T2P4",    ROM_P55T2P4,     { "Intel", cpus_Pentium, "IDT", cpus_WinChip, "",      NULL},         0, 1,   1, 512, 1,     at_p55t2p4_init},
        {"Award 430VX PCI",     ROM_430VX,       { "Intel", cpus_Pentium, "IDT", cpus_WinChip, "",      NULL},         0, 1,   1, 256, 1,      at_i430vx_init},
        {"Epox P55-VA",         ROM_P55VA,       { "Intel", cpus_Pentium, "IDT", cpus_WinChip, "",      NULL},         0, 1,   1, 256, 1,       at_p55va_init},
        {"", -1, {"", 0, "", 0, "", 0}, 0,0,0, 0}
};
