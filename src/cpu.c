...
void cpu_set()
{
		...
		//Fake timings.
                ...
                timing_int_v86      = 27;
                timing_int_pm       = 13;
                timing_int_pm_outer = 21;
                timing_iret_rm       = 3;
                timing_iret_v86      = 14; /*unknown*/
                timing_iret_pm       = 5;
                timing_iret_pm_outer = 14;
                timing_call_rm = 2;
                timing_call_pm = 2;
                timing_call_pm_gate = 11;
                timing_call_pm_gate_inner = 22;
                timing_retf_rm       = 2;
                timing_retf_pm       = 2;
                timing_retf_pm_outer = 12;
                timing_jmp_rm      = 2;
                timing_jmp_pm      = 2;
                timing_jmp_pm_gate = 9;
                cpu_hasrdtsc = 1;
                msr.fcr = (1 << 8) | (1 << 9) | (1 << 12) |  (1 << 16) | (1 << 19) | (1 << 21);
                cpu_hasMMX = 1;
                cpu_hasMSR = 1;
